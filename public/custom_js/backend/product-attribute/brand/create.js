    ...
    $(document).on('click','.addBrandModal',function(){
        var url = $('.addBrandModalRoute').val();
    ...
    */
        ...
        $.ajax({
            ...
            success:function(response){
                $('#addBrandModal').html(response).modal('show');
    ...
    $(document).on("submit",'.storeBrandData',function(e){
        e.preventDefault();
        var form = $(this);
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    setTimeout(function(){
                        ...
                        //for regular process
                        $('#addBrandModal').modal('hide');//hide modal
                    },1000);
