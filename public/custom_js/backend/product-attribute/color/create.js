    ...
    $(document).on('click','.addColorModal',function(){
        var url = $('.addColorModalRoute').val();
        ...
        */
        $.ajax({
            ...
            success:function(response){
                $('#addColorModal').html(response).modal('show');
    ...
    $(document).on("submit",'.storeColorData',function(e){
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    form[0].reset();
                    //$('#addColorModal').html(response).modal('hide');
                    setTimeout(function(){
                        //for regular process
                        ...
                        //for regular process
                        $('#addColorModal').modal('hide');//hide modal
                    },1000);
