    ...
    $(document).on('click','.addProductGradeModal',function(){
        var url = $('.addProductGradeModalRoute').val();
        ...
        */
        $.ajax({
            ...
            success:function(response){
                $('#addProductGradeModal').html(response).modal('show');
    ...
    $(document).on("submit",'.storeProductGradeData',function(e){
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    form[0].reset();
                    //$('#addProductGradeModal').html(response).modal('hide');
                    setTimeout(function(){
                        //for regular process
                        ...
                        //for regular process
                        $('#addProductGradeModal').modal('hide');//hide modal
                    },1000);
