    ...
    $(document).on('click','.addUnitModal',function(){
        var url = $('.addUnitModalRoute').val();
        /*
        |-----------------------------------------------
        ...
        */
        $.ajax({
            ...
            success:function(response){
                $('#addUnitModal').html(response).modal('show');
                /*
                |-------------------------------------
    ...
    $(document).on("submit",'.storeUnitData',function(e){
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    form[0].reset();
                    //$('#addUnitModal').html(response).modal('hide');
                    setTimeout(function(){
                        //for regular process
