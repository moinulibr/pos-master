    ...
    $(document).on('click','.addWarehouseRackModal',function(){
        var url = $('.addWarehouseRackModalRoute').val();
        ...
        */
        $.ajax({
            ...
            success:function(response){
                $('#addWarehouseRackModal').html(response).modal('show');
                /*
                |-------------------------------------
    ...
    $(document).on("submit",'.storeWarehouseRackData',function(e){
        e.preventDefault();
        var form = $(this);
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    setTimeout(function(){
                        ...
                        //for regular process
                        $('#addWarehouseRackModal').modal('hide');//hide modal
                    },1000);
