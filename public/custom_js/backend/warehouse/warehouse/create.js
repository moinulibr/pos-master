    ...
    $(document).on('click','.addWarehouseModal',function(){
        var url = $('.addWarehouseModalRoute').val();
        ...
        */
        $.ajax({
            ...
            success:function(response){
                $('#addWarehouseModal').html(response).modal('show');
    ...
    $(document).on("submit",'.storeWarehouseData',function(e){
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    form[0].reset();
                    //$('#addWarehouseModal').html(response).modal('hide');
                    setTimeout(function(){
                        //for regular process
                        ...
                        $('#addWarehouseModal').modal('hide');//hide modal
                    },1000);
