            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.customer.store.add.loan')}}" method="POST" class="storeAddLoanDate modal-content">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">
                            Customer 
                            <span class="font-weight-light">Add Loan</span>
                            <br />
                        </h5>
                    ...
                    <div class="modal-body" style="margin-left:30px;margin-right:30px;">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-form-label text-sm-right">Previous Loan</label>
                                <input type="text" disabled class="form-control" value="{{$customer->total_loan}}">
                                <div class="clearfix"></div>
                            </div>
                            
                            <div class="col-sm-6">
                                <label class="col-form-label text-sm-right">Loan Amount</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <label class="col-form-label text-sm-right">Loan Reason/Note</label>
