<div class="modal-dialog modal-lg">
    <form action="{{route('admin.product.grade.update')}}" method="POST" class="updateProductGradeData modal-content">
        @csrf
        ...
        <div class="modal-header">
            <h5 class="modal-title">
                ...
                <br />
                {{-- <small class="text-muted">Add New Product Grade</small> --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input name="name" value="{{$productGrade->name}}" type="text" class="form-control" placeholder="Name">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea name="description" class="form-control" placeholder="Description">{{$productGrade->description}}</textarea>
