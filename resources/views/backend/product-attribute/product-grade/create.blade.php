            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.product.grade.store')}}" method="POST" class="storeProductGradeData modal-content">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="name" type="text" class="form-control" placeholder="Product Grade Name">
