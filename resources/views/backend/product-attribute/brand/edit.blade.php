<div class="modal-dialog modal-lg">
    <form action="{{route('admin.brand.update')}}" method="POST" class="updateBrandData modal-content">
        @csrf
        ...
        <div class="modal-header">
            <h5 class="modal-title">
                ...
                <br />
                {{-- <small class="text-muted">Add New brand</small> --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input name="name" value="{{$brand->name}}" type="text" class="form-control" placeholder="Name">
