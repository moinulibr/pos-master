<div class="modal-dialog modal-sm">
    <div class="modal-content">
        <div class="modal-header" style="background-color:#f9f5f4;"> <!---#e2f7f6;-->
            ...
            <button type="button" style="color:red;" class="close cancelRemoveAllItemFromSaleCart" data-dismiss="modal" aria-label="Close">×</button>
        </div>
        ...
        <div class="modal-body " style="background-color:#ede7e7;"><!-- #e2f7f6; modal body-->
            ...
            <div class="form-group" style="text-align: center">
                <strong>Do you want to delete all item?</strong>
            </div>
