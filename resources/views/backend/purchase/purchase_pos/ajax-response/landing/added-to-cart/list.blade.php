    ...
    <div class="table-responsive table-datapos col-md-12" id="printableTable">
        ...
        Segoe UI, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, sans-serif;">
            ...
            <tbody>
                @php
                    $cartName = [];
                    $cartName     = session()->has(purchaseCreateCartSessionName_hh()) ? session()->get(purchaseCreateCartSessionName_hh())  : [];
                    $totalProduct = 1;
                @endphp
                ...
                <tr style="border-bottom: 0.05px dashed #dddfe0;">
                    ...
                    <td style="text-align:center;background-color: #f5f5f5;padding-top:1%;padding-bottom:1%;">
                        ...
                        <span id="set-1" class="total_cart_quantity">{{$item['purchase_qty']}}</span>
                ...
                @empty
                <tr>
                    <th colspan="7" style="text-align: center;border-bottom: 1px solid ##f7f7f7;">No data found</th>
                </tr>
                @endforelse
            </tbody>
        </table>
