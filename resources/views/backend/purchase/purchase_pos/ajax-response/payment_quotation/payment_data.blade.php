    ...
    <div class="col-md-12">
        <div class="table">
            <table class="table table-bordered table striped">
                <tr>
                    <td colspan="6" style="text-align: center">Supplier Information</td>
                </tr>
                <tr>
                    <td style="width:17%">Supplier Name</td>
                    <td style="width:1%">:</td>
                    <td style="width:50%">{{$supplier->name}}</td>

                    <td style="width:17%">Phone</td>
                    <td style="width:1%">:</td>
                    <td style="width:18%">{{$supplier->phone}}</td>
                </tr>
                <tr>
                    <td style="width:17%">Supplier Type</td>
                    <td style="width:1%">:</td>
                    <td style="width:50%">{{$supplier->supplierTypies ? $supplier->supplierTypies->name : NULL}}</td>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <label class="text-body">Reference No</label>
        <fieldset class="form-group mb-3">
    ...
    <div class="col-md-6">
        ...
        <fieldset class="form-group mb-3">
            <input type="file" name="attach_file" style="display:block!important;" accept='.jpg,.png,.gif,.pdf' />
        </fieldset>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <textarea name="shipping_note" id="" cols="5" rows="2" class="form-control"></textarea>
    </div>
</div>
