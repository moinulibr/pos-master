...
<div class="modal-dialog modal-lg modal-full" role="document">
    <div class="modal-content">
        ...
        <form action="{{route('admin.purchase.regular.purchase.view.single.invoice.wise.payment.making.modal')}}" method="POST"  class="storeSingleInvoiceWisePaymentData" enctype="multipart/form-data">
            @csrf
                                ...
                                <td style="width:24.5%">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="float:right;width:70%;">
                                            <input disabled type="text"  style="color:yellow!important;" class="form-control total_invoice_amount_for_calculator"  value="{{$data->total_payable_amount}}"  placeholder="Invoice Amount">
                                        </div> 
                                    </div> 
                                </td>
                                <td style="width:24.5%">
