            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.reference.store')}}" method="POST" class="storeReferenceData modal-content">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="name" type="text" class="form-control" placeholder="Reference Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="profession" value=""  type="text"   type="text" class="form-control" placeholder="Profession">
