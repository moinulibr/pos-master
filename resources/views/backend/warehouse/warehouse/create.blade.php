            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.warehouse.store')}}" method="POST" class="storeWarehouseData modal-content">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="name" type="text" class="form-control" placeholder="Warehouse Name">
