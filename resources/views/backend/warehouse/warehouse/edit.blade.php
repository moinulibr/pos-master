<div class="modal-dialog modal-lg">
    <form action="{{route('admin.warehouse.update')}}" method="POST" class="updateWarehouseData modal-content">
        @csrf
        ...
        <div class="modal-header">
            <h5 class="modal-title">
                ...
                <br />
                {{-- <small class="text-muted">Add New Warehouse</small> --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input name="name" value="{{$warehouse->name}}" type="text" class="form-control" placeholder=" Name">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea name="description" class="form-control" placeholder="Description">{{$warehouse->description}}</textarea>
